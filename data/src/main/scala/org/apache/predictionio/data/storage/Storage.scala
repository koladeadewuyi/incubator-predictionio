...
//export PIO_STORAGE_REPOSITORIES_METADATA_NAME=predictionio_metadata
//export PIO_STORAGE_REPOSITORIES_MODELDATA_NAME=predictionio_modeldata
//export PIO_STORAGE_REPOSITORIES_EVENTDATA_NAME=predictionio_eventdata
//
//export PIO_STORAGE_REPOSITORIES_METADATA_SOURCE=CASSANDRA
//export PIO_STORAGE_REPOSITORIES_EVENTDATA_SOURCE=CASSANDRA
//export PIO_STORAGE_REPOSITORIES_MODELDATA_SOURCE=CASSANDRA
//
//export PIO_STORAGE_SOURCES_CASSANDRA_TYPE=cassandra
//export PIO_STORAGE_SOURCES_CASSANDRA_HOSTS=127.0.0.1
//export PIO_STORAGE_SOURCES_CASSANDRA_HOME=/usr/local/Cellar/cassandra/3.10_1
